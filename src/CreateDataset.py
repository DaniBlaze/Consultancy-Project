...
def generate_enhanced_dataset(df):
    # Sorting the dataset to ensure that the first anchor/wait is actually the first one for the given vessel, as there can be multiple docking processes for a given vessel in our dataset
    ...
    print(df_first_waiting_observations_with_full_wait_time.head())
